...
/**================================================================================================
 *? All Content in this file can be accessed via cls.display.(method)
 *================================================================================================**/

let quizAssigned = [];
let quicCompleted = [];
let currentClassId;
let loadedClassAlready = false;
...
cls.display = {
     ...
     *@return type
     *=============================================**/
    /* This is the function that is called when the user clicks on the class card. It will load the class
    page with the relevant information. */
    loadHome: function() {
        // check if loaded already
        if (loadedClassAlready) {
    ...
    createClassCard: function(_classObject) {
        ...
        let newClassCardDesign = `
            <div class="card col-sm-6" id="classCard-a-${_classObject.code}" data-class="${_classObject.code}" style='margin-bottom: 2%;' id="classId-${_classObject.code}">
    ...
    loadClassPage: async function(_classId) {
        ...
        $('#classpage_authed_student-quizcompleted').empty()
